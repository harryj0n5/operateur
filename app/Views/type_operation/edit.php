...
<head>
    ...
    <title>Vola - Modifier un type d'operation</title>
...
<div class="admin-shell">
    ...
    <main class="admin-main">
        ...
        <a href="/type-operations" class="back-link"><i class="ti ti-arrow-left"></i> Retour aux types d'operation</a>
        <h1 style="margin-bottom:20px;">Modifier un type d'operation</h1>
