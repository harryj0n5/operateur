...
<div class="admin-shell">
    ...
    <aside class="admin-sidebar">
        ...
        <nav class="admin-nav">
            ...
            <a href="<?= site_url('user/logout') ?>" style="margin-top:16px;"><i class="ti ti-logout"></i> Deconnexion</a>
        </nav>
    </aside>
    ...
    <main class="admin-main">
        ...
        <div class="admin-topline">
            ...
            <a href="<?= site_url('user/logout') ?>" class="btn btn-outline btn-sm"><i class="ti ti-logout"></i> Deconnexion</a>
        </div>
